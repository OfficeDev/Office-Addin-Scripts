...
const addInTelemetry = new OfficeAddinTelemetry("de0d9e7c-1f46-4552-bc21-4e43e489a015", telemetryType.applicationinsights,"tester");
...
const path = require('os').homedir()+ "/mochaTest.txt";
    ...
    describe('test checkPrompt method', () => {
          ...
          it('should check to see if text is in file if already created, if appropriate word(s) are not in, returns true and writes to file. Writes both instrumentationkey and link string if needed', () => {
   ...
   describe('test parseErrors method', () => {
    ...
    at Object.<anonymous> (coreTests.ts:7:13)`;//may throw error if change any part of the top of the test file
