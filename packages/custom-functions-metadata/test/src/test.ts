...
describe("test json file created", function() {
    describe("generate test", function(){
        it("test it", function() {
            var inputFile = "../custom-functions-metadata/test/typescript/testfunctions.ts";
...
describe("test javascript file as input", function() {
    describe("js test", function(){
        it("basic test", function() {
            var inputFile = "../custom-functions-metadata/test/javascript/testjs.js";
...
describe("test errors", function() {
    describe("failure to generate", function(){
        it("test error", function() {
             var inputFile = "../custom-functions-metadata/test/javascript/errorfunctions.js";
