...
describe("test errors", function() {
    describe("failure to generate", function() {
        it("test error", async function() {
             ...
             assert.equal(errtest[4], `The custom function name "1invalidname" should start with an alphabetic character. (22,18)`);
             assert.equal(errtest[5], `The custom function name "1invalidname" should contain only alphabetic characters, numbers (0-9), period (.), and underscore (_). (22,18)`);
