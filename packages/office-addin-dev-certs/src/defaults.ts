...
export const localhostCaCertificateFileName = "ca.crt";
export const localhostCaCertificatePath = path.join(certificateDirectory, localhostCaCertificateFileName);
