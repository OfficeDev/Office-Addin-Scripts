...
export const azRestAddSecretCommandPath = path.resolve(
  `${__dirname}/scripts/azAddSecretCmd.txt`
);
...
export const addSecretCommandPath: string = path.resolve(
  `${__dirname}/scripts/addAppSecret.ps1`
);
export const getSecretCommandPath: string = path.resolve(
  `${__dirname}/scripts/getAppSecret.ps1`
);
export const testEnvDataFilePath = path.resolve(
  `${process.cwd()}/test/test-env`
);
export const testFallbackAuthDialogFilePath: string = path.resolve(
  `${process.cwd()}/test/test-fallbackauthdialog`
);
export const testManifestFilePath = path.resolve(
  `${process.cwd()}/test/test-manifest.xml`
);
